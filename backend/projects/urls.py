...
from .views.contractor_discovery import (
    ...
    ContractorOpportunityAgreementDraftView,
...
from .views.proposals import (
    ...
    ProposalCustomerPreviewView,
    ProposalSendReviewView,
    ProposalMessageView,
    PublicProposalMessageView,
    PublicProposalReviewView,
    ProposalPortalActivationView,
    ProposalTemplatePricingApplyView,
...
from .views.amendment_requests import ContractorAgreementAmendmentImproveView, ContractorAgreementAmendmentRequestView, AmendmentRequestResponseView, AmendmentRequestViewedView
...
from .views.measurement import ManualMeasurementPreviewView, MeasurementSessionDetailView
...
from .views.customer_portal import (
    ...
    CustomerPortalNotificationCleanupPreferenceView,
    CustomerPortalNotificationPreferenceView,
    CustomerPortalNotificationMarkAllReadView,
    CustomerPortalNotificationMarkReadView,
    CustomerPortalNotificationRestoreView,
    CustomerPortalProfileView,
    CustomerPortalRentalOperationsCheckoutView,
    CustomerPortalTeamMemberView,
    CustomerPortalVendorBusinessSearchView,
    CustomerPortalVendorContractorSearchView,
    CustomerPortalVendorImportView,
    CustomerPortalVendorView,
    CustomerPortalHomeSystemView,
    CustomerPortalHomeSystemReminderDetailView,
    ...
    CustomerPortalPropertyWorkOrderAgreementDraftView,
    CustomerPortalPropertyWorkOrderContractorMatchView,
    CustomerPortalPropertyWorkOrderMarketplaceView,
    CustomerPortalPropertyWorkOrderView,
    PropertyWorkOrderRecipientInvitationResponseView,
    CustomerPortalPropertyUnitBulkView,
    CustomerPortalPropertyUnitView,
    CustomerPortalPropertyProfileView,
    CustomerPortalSmartCaptureApproveView,
    CustomerPortalSmartCaptureCancelView,
    CustomerPortalSmartCaptureDetailView,
    CustomerPortalSmartCaptureRetryView,
    CustomerPortalSmartCaptureView,
    CustomerPortalTenantMaintenanceRequestView,
    CustomerPortalTenantView,
    CustomerPortalPropertyUploadView,
    TenantMaintenanceRequestPublicView,
    TenantMaintenanceRequestStatusView,
    TenantMaintenanceRequestVerifiedSubmitView,
    TenantMaintenanceRequestVerifyView,
...
urlpatterns = [
    ...
    path("measurements/manual-preview/", ManualMeasurementPreviewView.as_view(), name="measurement-manual-preview"),
    ...
    path("customer-portal/<str:token>/team-members/", CustomerPortalTeamMemberView.as_view(), name="customer-portal-team-members"),
    path("customer-portal/<str:token>/team-members/<int:member_id>/", CustomerPortalTeamMemberView.as_view(), name="customer-portal-team-member-detail"),
    path("customer-portal/<str:token>/vendor-search/contractors/", CustomerPortalVendorContractorSearchView.as_view(), name="customer-portal-vendor-search-contractors"),
    path("customer-portal/<str:token>/vendor-search/businesses/", CustomerPortalVendorBusinessSearchView.as_view(), name="customer-portal-vendor-search-businesses"),
    path("customer-portal/<str:token>/vendors/", CustomerPortalVendorView.as_view(), name="customer-portal-vendors"),
    path("customer-portal/<str:token>/vendors/import/", CustomerPortalVendorImportView.as_view(), name="customer-portal-vendor-import"),
    path("customer-portal/<str:token>/vendors/<int:vendor_id>/", CustomerPortalVendorView.as_view(), name="customer-portal-vendor-detail"),
    path("customer-portal/<str:token>/smart-capture/sessions/", CustomerPortalSmartCaptureView.as_view(), name="customer-portal-smart-capture-sessions"),
    path("customer-portal/<str:token>/smart-capture/sessions/<uuid:session_id>/", CustomerPortalSmartCaptureDetailView.as_view(), name="customer-portal-smart-capture-detail"),
    path("customer-portal/<str:token>/smart-capture/sessions/<uuid:session_id>/retry/", CustomerPortalSmartCaptureRetryView.as_view(), name="customer-portal-smart-capture-retry"),
    path("customer-portal/<str:token>/smart-capture/sessions/<uuid:session_id>/approve/", CustomerPortalSmartCaptureApproveView.as_view(), name="customer-portal-smart-capture-approve"),
    path("customer-portal/<str:token>/smart-capture/sessions/<uuid:session_id>/cancel/", CustomerPortalSmartCaptureCancelView.as_view(), name="customer-portal-smart-capture-cancel"),
    path("customer-portal/<str:token>/properties/<int:property_id>/units/", CustomerPortalPropertyUnitView.as_view(), name="customer-portal-property-units"),
    path("customer-portal/<str:token>/properties/<int:property_id>/units/bulk/", CustomerPortalPropertyUnitBulkView.as_view(), name="customer-portal-property-units-bulk"),
    path("customer-portal/<str:token>/properties/<int:property_id>/units/<int:unit_id>/", CustomerPortalPropertyUnitView.as_view(), name="customer-portal-property-unit-detail"),
    path("customer-portal/<str:token>/properties/<int:property_id>/tenants/", CustomerPortalTenantView.as_view(), name="customer-portal-property-tenants"),
    path("customer-portal/<str:token>/properties/<int:property_id>/tenants/<int:tenancy_id>/", CustomerPortalTenantView.as_view(), name="customer-portal-property-tenant-detail"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/", CustomerPortalPropertyWorkOrderView.as_view(), name="customer-portal-property-work-orders"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/<int:work_order_id>/", CustomerPortalPropertyWorkOrderView.as_view(), name="customer-portal-property-work-order-detail"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/<int:work_order_id>/contractor-matches/", CustomerPortalPropertyWorkOrderContractorMatchView.as_view(), name="customer-portal-property-work-order-contractor-matches"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/<int:work_order_id>/send-to-marketplace/", CustomerPortalPropertyWorkOrderMarketplaceView.as_view(action="send"), name="customer-portal-property-work-order-send-marketplace"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/<int:work_order_id>/withdraw-marketplace/", CustomerPortalPropertyWorkOrderMarketplaceView.as_view(action="withdraw"), name="customer-portal-property-work-order-withdraw-marketplace"),
    path("customer-portal/<str:token>/properties/<int:property_id>/work-orders/<int:work_order_id>/create-agreement-draft/", CustomerPortalPropertyWorkOrderAgreementDraftView.as_view(), name="customer-portal-property-work-order-create-agreement-draft"),
    path("customer-portal/<str:token>/properties/<int:property_id>/tenant-maintenance-requests/", CustomerPortalTenantMaintenanceRequestView.as_view(), name="customer-portal-tenant-maintenance-requests"),
    path("customer-portal/<str:token>/properties/<int:property_id>/tenant-maintenance-requests/<int:request_id>/", CustomerPortalTenantMaintenanceRequestView.as_view(), name="customer-portal-tenant-maintenance-request-detail"),
    path("customer-portal/<str:token>/properties/<int:property_id>/tenant-maintenance-requests/<int:request_id>/create-work-order/", CustomerPortalTenantMaintenanceRequestView.as_view(), name="customer-portal-tenant-maintenance-request-create-work-order"),
    path("maintenance-request/verify/", TenantMaintenanceRequestVerifyView.as_view(), name="tenant-maintenance-request-verify"),
    path("maintenance-request/verified-submit/", TenantMaintenanceRequestVerifiedSubmitView.as_view(), name="tenant-maintenance-request-verified-submit"),
    path("maintenance-request/status/<uuid:token>/", TenantMaintenanceRequestStatusView.as_view(), name="tenant-maintenance-request-status"),
    path("maintenance-request/<str:token>/", TenantMaintenanceRequestPublicView.as_view(), name="tenant-maintenance-request-public"),
    path("work-order-invitations/<uuid:token>/<str:action>/", PropertyWorkOrderRecipientInvitationResponseView.as_view(), name="property-work-order-recipient-invitation-response"),
    ...
    path("customer-portal/<str:token>/property/systems/<int:system_id>/reminder/", CustomerPortalHomeSystemReminderDetailView.as_view(), name="customer-portal-home-system-reminder-detail"),
    ...
    path(
        "customer-portal/<str:token>/notifications/<int:notification_id>/restore/",
        CustomerPortalNotificationRestoreView.as_view(),
        name="customer-portal-notification-restore",
    ),
    path(
        "customer-portal/<str:token>/notifications/cleanup-preferences/",
        CustomerPortalNotificationCleanupPreferenceView.as_view(),
        name="customer-portal-notification-cleanup-preferences",
    ),
    path(
        "customer-portal/<str:token>/notifications/preferences/",
        CustomerPortalNotificationPreferenceView.as_view(),
        name="customer-portal-notification-preferences",
    ),
    ...
    path("proposals/<int:proposal_id>/messages/", ProposalMessageView.as_view()),
    path("proposal-reviews/<str:token>/", PublicProposalReviewView.as_view()),
    path("proposal-reviews/<str:token>/messages/", PublicProposalMessageView.as_view()),
    path("proposal-portal-activations/<str:token>/", ProposalPortalActivationView.as_view()),
    path("proposals/<int:proposal_id>/line-items/", ProposalLineItemListCreateView.as_view()),
    path("proposals/<int:proposal_id>/apply-template-pricing/", ProposalTemplatePricingApplyView.as_view()),
    path("proposals/<int:proposal_id>/line-items/<int:line_item_id>/", ProposalLineItemDetailView.as_view()),
    ...
    path("projects/workspace-context/", WorkspaceContextView.as_view(), name="workspace-context-legacy"),
