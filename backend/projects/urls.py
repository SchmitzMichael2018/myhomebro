...
urlpatterns = [
    ...
    path("employee/milestones/<int:milestone_id>/comments/<int:comment_id>/", update_or_delete_comment),
    path("employee/milestones/<int:milestone_id>/files/", upload_file),
    path("employee/milestones/<int:milestone_id>/files/<int:file_id>/", delete_file),
