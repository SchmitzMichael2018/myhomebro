...
class PropertyProfile(models.Model):
    ...
    is_rental_property = models.BooleanField(default=False, db_index=True)
...
class SmartNotificationEvent(models.TextChoices):
    ...
    WARRANTY_REQUEST_RECEIVED = "warranty_request_received", "Warranty Request Received"
    WARRANTY_INFORMATION_REQUESTED = "warranty_information_requested", "Warranty Information Requested"
    WARRANTY_INSPECTION_SCHEDULED = "warranty_inspection_scheduled", "Warranty Inspection Scheduled"
    WARRANTY_COVERAGE_DECISION = "warranty_coverage_decision", "Warranty Coverage Decision"
    WARRANTY_REPAIR_SCHEDULED = "warranty_repair_scheduled", "Warranty Repair Scheduled"
    WARRANTY_REPAIR_COMPLETED = "warranty_repair_completed", "Warranty Repair Completed"
    WARRANTY_ACKNOWLEDGMENT_REQUESTED = "warranty_acknowledgment_requested", "Warranty Acknowledgment Requested"
    WARRANTY_CLOSED = "warranty_closed", "Warranty Closed"
    WARRANTY_ESCALATED = "warranty_escalated", "Warranty Escalated"
