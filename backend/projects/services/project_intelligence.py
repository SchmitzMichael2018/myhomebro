...
PROJECT_TYPE_FAMILIES: list[dict[str, Any]] = [
    {
        "key": "addition",
        "label": "Addition",
        "cue_label": "Addition-focused review",
        "keywords": [
            "addition",
            "bedroom addition",
            "room addition",
        ...
        "prep_items": [
            "Confirm the new space, approximate size, and tie-in location.",
            "Review framing, foundation, roof, and utility assumptions.",
            "Clarify finish level and permit expectations.",
            "Note access, staging, and schedule constraints.",
        ],
        "response_starter": "I reviewed the addition details and can confirm the new space, tie-ins, and next steps before pricing.",
        "create_bid_context": "Addition projects are clearer when the new space, structure, utilities, finishes, and permit expectations are confirmed.",
        "draft_focus_line": "Addition projects benefit from confirming the new space, structural tie-ins, finish level, and permit expectations before final pricing.",
    },
    {
        "key": "roofing",
        "label": "Roofing",
    ...
    },
    {
        "key": "carpentry",
        "label": "Carpentry",
        "cue_label": "Carpentry-focused review",
        "keywords": [
            "carpentry",
            "wood repair",
            "wood rot",
        ...
        "prep_items": [
            "Confirm the wood components and affected areas.",
            "Review whether repair, restoration, or replacement is expected.",
            "Clarify finish, paint, stain, or trim matching needs.",
            "Note access, weather exposure, and hidden damage assumptions.",
        ],
        "response_starter": "I reviewed the carpentry details and can confirm the affected wood components, finish expectations, and next steps before pricing.",
        "create_bid_context": "Carpentry repairs are clearer when the affected components, material matching, finish expectations, and hidden damage assumptions are confirmed.",
        "draft_focus_line": "Carpentry work benefits from confirming the affected wood components, material matching, finish expectations, and hidden damage assumptions before final pricing.",
    },
    {
        "key": "handyman",
