...
SEED_PROJECT_SPECS: list[SeedProjectSpec] = [
    SeedProjectSpec(
        ...
        duration_low=14,
        duration_high=35,
        description="Reusable kitchen remodel template covering planning, demolition, rough-ins, finishes, and closeout.",
        scope_text="Coordinate selections, demo the existing kitchen, complete required rough-ins, install cabinetry and surfaces, and finish the project with punch work.",
    ...
    SeedProjectSpec(
        ...
        duration_low=7,
        duration_high=21,
        description="Reusable bathroom remodel template covering protection, demo, waterproofing, tile, fixtures, and closeout.",
        scope_text="Protect adjacent finishes, remove the existing bathroom scope, complete waterproofing and tile work, install fixtures, and finish with final cleanup.",
    ...
    SeedProjectSpec(
        ...
        duration_low=2,
        duration_high=7,
        description="Reusable roof replacement template covering tear-off, weatherproofing, installation, and final review.",
        scope_text="Remove the existing roof system, review decking conditions, install the new roofing assembly, and complete cleanup and final review.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Prepare the substrate, complete underlayment and layout work, install the flooring system, and finish transitions and cleanup.",
        ...
        milestone_pattern=[
            {"title": "Site Prep", "normalized_milestone_type": "site_preparation", "duration_days": 1},
            {"title": "Underlayment & Layout", "normalized_milestone_type": "site_preparation", "duration_days": 1},
            {"title": "Main Installation", "normalized_milestone_type": "flooring_installation", "duration_days": 2},
            {"title": "Trim & Cleanup", "normalized_milestone_type": "cleanup", "duration_days": 1},
        ],
        clarifications=[
    ...
    SeedProjectSpec(
        ...
        scope_text="Protect the work areas, complete prep and patching, apply the specified coats, and finish with touch-up and cleanup.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Confirm layout and material readiness, prepare the work area, install cabinets, complete alignment, and finish punch items.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Prepare the substrate and cabinet bases, coordinate field measurements, install countertops, and complete sink and fixture closeout.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Stage the appliance, prepare utility connections and clearances, complete installation, test operation, and review the handoff.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Review the approved electrical scope, complete rough wiring or device work, test the installation, and finish trim-out and walkthrough.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Diagnose the issue, complete the approved plumbing repair or replacement, test performance, and finish cleanup and handoff.",
    ...
    SeedProjectSpec(
        ...
        duration_low=2,
        duration_high=10,
        description="Reusable deck build template covering layout, footings, framing, decking, rails, and final review.",
        scope_text="Lay out the deck, complete footing and framing work, install decking and rails, and finish with final review and cleanup.",
        source_note="Seeded outdoor construction baseline for residential deck projects.",
    ...
    SeedProjectSpec(
        ...
        scope_text="Lay out the fence line, set posts, install panels and gates, and finish with final adjustments and walkthrough.",
