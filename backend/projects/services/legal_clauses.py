...
def build_legal_notices(project_state: Optional[str] = None) -> List[Clause]:
    ...
    IMPORTANT:
    - These are CONTRACTOR ↔ HOMEOWNER agreement clauses.
    ...
    clauses.append((
        ...
        "Contractor is an independent contractor and not an employee, agent, partner, or joint venturer of the Homeowner. "
    ...
    clauses.append((
        ...
        "any employee, crew member, or subcontractor of Contractor, or (b) the platform and any such person. Homeowner is "
        ...
        "Homeowner is responsible for providing reasonably safe access to the property, disclosing known hazards, and "
        "maintaining appropriate property and liability insurance for conditions or hazards under Homeowner’s control."
    ))
    ...
    clauses.append((
        ...
        "shown in this Agreement represents the amount owed by the Homeowner for the work described. Separate payment "
    ...
    clauses.append((
        "Insurance",
        "Contractor represents it maintains commercially reasonable insurance appropriate for the work. Homeowner must "
    ...
    clauses.append((
        "Entire Agreement",
        "This document and its signed Change Orders constitute the entire agreement between Contractor and Homeowner for "
        "the work described."
    ))
