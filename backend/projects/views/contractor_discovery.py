...
def _opportunity_payload(opportunity: ContractorOpportunity) -> dict:
    ...
    payload = {
        ...
        "outreach_status_label": opportunity.get_outreach_status_display(),
        "outreach_attempted_at": opportunity.outreach_attempted_at,
        "outreach_delivered_at": opportunity.outreach_delivered_at,
