...
from .views_recommendations import AdminRecommendationsView
...
urlpatterns = [
    ...
    path("homeowners/<int:homeowner_id>/", AdminHomeownerDetail.as_view(), name="admin-homeowner-detail"),
