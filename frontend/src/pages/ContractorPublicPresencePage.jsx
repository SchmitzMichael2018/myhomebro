        ...
        <main className="px-5 pb-6 lg:px-6" data-testid="online-presence-step-content">
          ...
          {activeTab === 'gallery' ? (
            <section className="grid min-w-0 items-start gap-4 xl:grid-cols-[minmax(0,1fr)_280px]" data-testid="public-presence-gallery-tab">
              <div className="min-w-0">
                <div className="flex flex-wrap items-start justify-between gap-3"><div><h2 className="text-2xl font-black text-slate-950">Portfolio</h2><p className="mt-1 text-sm text-slate-600">Showcase your best work to build trust and win more business.</p></div><button type="button" onClick={() => setGalleryEditorOpen(true)} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-black text-white" data-testid="portfolio-add-project">+ Add Item</button></div>
                ...
                <div className="mt-3 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  {galleryRows.length > 0 && galleryRows.length <= 5 ? <div className="m-3 flex flex-wrap items-center justify-between gap-3 rounded-xl bg-blue-50 p-3"><div><div className="text-sm font-black text-slate-950">Add more work to strengthen your portfolio.</div><div className="text-xs text-slate-600">A strong portfolio usually includes 3–5 clear examples of completed work.</div></div><button type="button" onClick={() => setGalleryEditorOpen(true)} className="rounded-lg bg-blue-600 px-3 py-2 text-xs font-bold text-white">+ Add Item</button></div> : null}
                </div>
              </div>
